        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Job Seeker List</h1>
...
<table id="example"class="table table-striped"style="overflow-x:auto;">
  ...
  <tbody>
    @foreach($users as $u)
    <tr>
      <td><img class="rounded-circle"src="upload/{{$u->pic_path}}"width="40px;"height="40px;"></td>
      <td>{{$u->name}}</td>
      <td>{{$u->nrc}}</td>
       <td>{{$u->email}}</td>
        <td>{{$u->address}}</td>
        ...
        @if($u->status ==1 && Auth::user()->role_id ==1)
      <td><a href="/deactive/{{$u->user_id}}"class="badge badge-danger">Deactivate</a></td>
      @endif


        @if($u->status ==0 && Auth::user()->role_id ==1)
      <td><a href="/active/{{$u->user_id}}"class="badge badge-success">Active</a></td>
      @endif
    </tr>
    @endforeach
  </tbody>
