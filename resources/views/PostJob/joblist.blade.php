 ...
 <table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$job->to_date}}</td>
      <td>
         <a href="edit/{{$job->job_id}}"data-mytitle="{{$job->job_name}}"data-type="{{$job->type_name}}"
          data-location="{{$job->location}}"data-description="{{$job->description}}"data-work="{{$job->work_type}}"data-salary="{{$job->salary}}"data-todate="{{$job->to_date}}"data-id="{{$job->job_id}}"


          data-toggle="modal" data-target="#exampleModal"class="badge badge-success">edit</a>
        <a href="javascript:myDelete({{$job->job_id}})"onclick="myDelete();"class="badge badge-danger">delete</a>
      </td>
    </tr>
    @endforeach
  </tbody>
...
{{ csrf_field() }}
<input type="hidden" class="form-control"id="id"name="jobID">
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <select type="text" class="form-control"id="comtype"name="comtype">
      @foreach($jo as $j)
  ...
  <div class="form-group">
    ...
    <select class="form-control custom-select"id="worktype"name="worktype">
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <textarea type="text"id="req"class="form-control"name="req"></textarea>
  </div>
 
  <button type="submit" class="btn btn-primary"><i class="fas fa-plus"></i>Update Job</button>
</form>
...
<footer class="sticky-footer bg-white">
 ...
 var salary =button.data('salary')
  ...
  modal.find('.modal-body #jname').val(title)
modal.find('.modal-body #comtype').val(type)
modal.find('.modal-body #location').val(location)
modal.find('.modal-body #req').val(description)
modal.find('.modal-body #worktype').val(work)
     ...
     swal({
      ...
      if (isConfirm) {
        swal({
          ...
          window.location.href="/delete/"+$id// <--- submit form programmatically
        });
      } else {
