        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Job Expired List</h1>
 ...
 <table id="example" class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$job->to_date}}</td>
      <td>
        <a href="javascript:myDelete({{$job->job_id}})"class="badges badges-danger"onclick="myDelete();"><i class="fas fa-trash-alt"></i></a>
     ...
     swal({
      ...
      if (isConfirm) {
        swal({
          ...
          window.location.href="/jobexpire/"+$id// <--- submit form programmatically
        });
      } else {
