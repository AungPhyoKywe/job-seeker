    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Job Apply List</h1>
...
<table id="example"class="table table-striped"style="overflow-x:auto;">
  ...
  <tbody>
    ...
    @foreach($applylist as $c)
           <td><img class="rounded-circle"src="upload/{{$c->pic_path}}"width="40px;"height="40px;"></td>
          <td>{{$c->name}}</td>
          <td>{{$c->job_name}}</td>
           <td>{{$c->created_at}}</td>
          <td><a href="/download/{{$c->cv}}"class="badge badge-primary"download> Download CV</a></td>
          
         

        @if( Auth::user()->role_id ==2)
      <td><a href="javascript:myDelete({{$c->jobapp_id}})"onclick="myDelete();"class="badge badge-danger">delete</a></td>
      @endif
...
<footer class="sticky-footer bg-white">
 ...
 @endif
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.12/js/jquery.dataTables.min.js"></script>
     ...
     swal({
      ...
      if (isConfirm) {
        swal({
          ...
          window.location.href="/deleteapplylist/"+$id// <--- submit form programmatically
        });
      } else {
